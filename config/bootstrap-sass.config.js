...
module.exports = {
  ...
  preBootstrapCustomizations: './styles/_pre-bootstrap-customizations.sass',
  ...
  bootstrapCustomizations: './styles/_bootstrap-customizations.sass',

  mainSass: './styles/main.sass',
